...
def fetch_etf_holdings():
    ...
    current_data = {
        ...
        '證券名稱': ['台積電', '鴻海', '聯發科', '主動統一全球創新', '元大台灣50', '元大高股息'],
        '持股股數': [1505000, 798000, 305000, 52000, 400000, 100000, 80000], # 模擬今日股數
        '持股比例': [28.6, 11.9, 9.4, 4.7, 3.2, 5.0, 4.5],           # 模擬今日比例
        '產業類別': ['半導體', '其他電子', '半導體', '電腦週邊', '指數型', '指數型', '指數型']
    }
